 ...
 * considered as MX tables while 2PC replicated tables with none distribution are
 * reference tables.
 */
bool
 ...
 * entry with the given properties. In the case of a condflict on placementId, the command
