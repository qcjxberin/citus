...
static void CreateTableMetadataOnMetadataWorkers(Oid relationId);
...
create_distributed_table(PG_FUNCTION_ARGS)
{
	...
	{
		CreateTableMetadataOnMetadataWorkers(relationId);
	}
...
/*
 * CreateTableMetadataOnMetadataWorkers creates the list of commands needed to create the
 ...
 */
static void
CreateTableMetadataOnMetadataWorkers(Oid relationId)
{
