...
get_shard_id_for_distribution_column(PG_FUNCTION_ARGS)
{
			 ...
			 distributionMethod == DISTRIBUTE_BY_RANGE)
	{
		...
		shardInterval = DistributionValueShard(relationId, distributionDataType,
											   distributionValue);
	}
	else
	{
...
/*
 * DistributionValueShard finds the shard which contains the given value of the
 * distribution column.
 */
ShardInterval *
DistributionValueShard(Oid relationId, Oid distributionDataType, Datum distributionValue)
{
	ShardInterval *shardInterval = NULL;
